...
use shooter_airsoft::{shooter_logic::ShooterGame, solana::anchor_client::GAME_PROGRAM};
...
enum CliCommand {
    ...
    Run {
        ...
        #[arg(long)]
        offline: bool,
        /// Rendered integration check; saves a screenshot and exits.
        #[arg(long)]
        smoke_test: bool,
    },
...
fn main() -> anyhow::Result<()> {
    ...
    match cli.command {
        ...
        CliCommand::Run {
            ...
            offline,
            smoke_test,
        } => crate::client::run_game(wallet, offline || smoke_test, smoke_test),
