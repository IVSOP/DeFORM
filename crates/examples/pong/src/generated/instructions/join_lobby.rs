...
impl JoinLobby {
    pub fn instruction(&self, args: JoinLobbyInstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = JoinLobbyInstructionData::new().try_to_vec().unwrap();
...
pub struct JoinLobbyInstructionData {
    discriminator: [u8; 8],
}

impl JoinLobbyInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for JoinLobbyInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
pub struct JoinLobbyInstructionArgs {
    pub id: u64,
}

impl JoinLobbyInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `JoinLobby`.
///
/// ### Accounts:
///
...
impl JoinLobbyBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = JoinLobbyInstructionArgs {
...
/// `join_lobby` CPI accounts.
pub struct JoinLobbyCpiAccounts<'a, 'b> {
...
/// `join_lobby` CPI instruction.
pub struct JoinLobbyCpi<'a, 'b> {
    ...
    pub __args: JoinLobbyInstructionArgs,
}

impl<'a, 'b> JoinLobbyCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: JoinLobbyCpiAccounts<'a, 'b>,
        args: JoinLobbyInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `JoinLobby` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` user
...
///   2. `[]` system_program
#[derive(Clone, Debug)]
pub struct JoinLobbyCpiBuilder<'a, 'b> {
    instruction: Box<JoinLobbyCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> JoinLobbyCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(JoinLobbyCpiBuilderInstruction {
            __program: program,
            user: None,
            lobby: None,
            system_program: None,
...
#[derive(Clone, Debug)]
struct JoinLobbyCpiBuilderInstruction<'a, 'b> {
